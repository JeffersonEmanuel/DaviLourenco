		...
		e.fx.multipleValueStep[k] = function(n) {
			...
			e.each(n.values, function(q) {
				...
				case 3:
					...
					break;
				case 4:
					o = parseFloat(m.e(3, 1).toFixed(6));
					break;
				case 5:
					o = parseFloat(m.e(3, 2).toFixed(6));
					break
				}
				n.values[q].now = o
			})
...
(function(c, b, a, d) {
	...
	c.extend(c.matrix, {
		...
		matrix : function() {
			...
			case 4:
				return new c.matrix.M2x2(e[0], e[2], e[1], e[3]);
			case 6:
				return new c.matrix.M3x3(e[0], e[2], e[4], e[1], e[3], e[5], 0, 0, 1)
			}
		},
		reflect : function() {
